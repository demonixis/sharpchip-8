...
namespace SharpChip8.OpenTK
{
    public class MainWindow : GameWindow
    {
        ...
        {
            this.Size = new Size((SharpChip8.Core.Screen.InternalWidth * width), (SharpChip8.Core.Screen.InternalHeight * height));
            SetupViewport();
            Pixel.PixelDim = width;
            _chip8.Screen.Reset();
        }
        ...
        private void UpdateAndDraw()
        {
            ...
            GL.LoadIdentity();
            GL.Begin(BeginMode.Quads); // Again : I KNOW !
