...
{
    public partial class OpenTKRenderer : Form
    {
        ...
        private void UpdateAndDraw()
        {
            ...
            GL.Begin(BeginMode.Quads); // I know...
        ...
        private void otkGLControl_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                DialogResult result = MessageBox.Show("Do you want to stop the emulation?", "Stop emulation", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        {
            string text = String.Format("SharpChip-8 is a Chip-8 interpretor/emulator.\nIt's open source and free. Take a look at the LICENCE file for more informations.\n\nYannick Comte");
            MessageBox.Show(text, "About SharpChip-8", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }

        // Aide
        private void helpItemMenu_Click(object sender, EventArgs e)
        {
            MessageBox.Show("You need chip8 roms to use this software (.ch8 or ck8). The emulation process starts automatically.", "SharpChip-8 help", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        #endregion
